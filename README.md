# 🎉 ratrioshka - Enhance Your Ratatui Experience

## 🏷️ Description
ratrioshka is a user-friendly widget designed to let you seamlessly add Ratatui to your Ratatui environment. This means you can expand your Ratatui applications with added functionality and customization options that suit your needs. 
...
To successfully run ratrioshka, ensure your system meets the following basic requirements:
...
2. Familiarize yourself with the user interface. You will see several options to customize your Ratatui experience.
3. Use the help section within the app for tutorials and tips on using the features.
...
- **Custom Widgets:** Easily add new widgets to your current setup.
- **Themes:** Choose themes to fit your personal style.
- **Extensions:** Add extensions for additional features.
